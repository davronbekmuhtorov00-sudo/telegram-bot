...
- Фақат мавжуд ўзбек сўзларини ишлат, янги сўз ясама
...
async def send_post():
    ...
    try:
        ...
        await asyncio.sleep(2)  # Telegramga biroz vaqt ber
    except RetryAfter as e:
        logger.warning(f"⏳ Telegram kutishni so'radi: {e.retry_after} soniya")
...
def setup_schedule():
    for hour in POST_HOURS_UTC:
        ...
        logger.info(f"📅 UTC {hour:02d}:00 = GMT+5 {gmt5:02d}:00 da post")
